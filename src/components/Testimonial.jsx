...
const Testimonial = () => {
  return (
    <>
      <div className="container h-auto mx-auto space-y-8  bg-slate-100 rounded-lg mt-24">
        <button className="border border-customBlue text-customBlue py-2 px-5 rounded-full  bg-white font-semibold text-lg">
          Testimonial
        </button>

        <p className="font-bold text-5xl text-customBlue">
        ...
        <div>
          ...
          >
            <SwiperSlide className="">
              <blockquote className="rounded-lg bg-faqColor p-6 shadow-sm sm:p-8">
                <h1 className="text-2xl font-bold text-customBlue">
                  Expertise and Compassion <br /> Combined
                </h1>
                <p className="mt-4 text-customBlue leading-tight">
                ...
                <div className="flex items-center gap-4 pt-5">
                  ...
                  <div>
                    <div className="flex justify-center gap-0.5 text-yellow-500 mr-10">
                      <svg
              ...
              <blockquote className="rounded-lg bg-faqColor p-6 shadow-sm sm:p-8">
                ...
                <div className="flex items-center gap-4 pt-5">
                  ...
                  <div>
                    ...
                    <p className="mt-0.5 text-sm font-bold text-gray-900">
                      Michael R,
                      <span className="font-semibold">Business Executive</span>
                    </p>
                  </div>
                </div>
              </blockquote>
